...
const RideCard = ({
  ...
  <View
    className="flex flex-row items-center justify-center bg-white 
                rounded-lg shadow-sm shadow-neutral-500 mb-3">
    <View className="flex flex-col items-center justify-center p-3">
      <View className="flex flex-row items-center justify-between">
        <Image
          source={{
            uri: `https://maps.geoapify.com/v1/staticmap?style=osm-bright&width=600&height=400
      ...
      <View
        className="flex flex-col w-full mt-5 bg-general-500 rounded-lg p-3 
        ...
        <View className="flex flex-row items-center w-full justify-between mb-5">
          ...
          <Text
            className={`capitalize text-md font-JakartaMedium text-gray-500 
